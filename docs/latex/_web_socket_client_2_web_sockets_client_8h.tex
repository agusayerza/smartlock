\hypertarget{_web_socket_client_2_web_sockets_client_8h}{}\doxysection{stomp\+Client-\/old/\+Web\+Socket\+Client/\+Web\+Sockets\+Client.h File Reference}
\label{_web_socket_client_2_web_sockets_client_8h}\index{stompClient-\/old/WebSocketClient/WebSocketsClient.h@{stompClient-\/old/WebSocketClient/WebSocketsClient.h}}
{\ttfamily \#include \char`\"{}Web\+Sockets.\+h\char`\"{}}\newline
\doxysubsection*{Classes}
\begin{DoxyCompactItemize}
\item 
class \mbox{\hyperlink{class_web_sockets_client}{Web\+Sockets\+Client}}
